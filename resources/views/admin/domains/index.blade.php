        ...
        <table id="manageDomainsTable" class="table table-hover table-striped"
            ...
            <thead class="bg-light">
                <tr>
                    ...
                    <th data-priority="3" class="text-center">Total Clicks</th>
                    <th data-priority="4" class="text-center">Created</th>
                    ...
                    <tr class="bg-white rounded shadow-sm">
                        ...
                        <td class="align-middle">
                            ...
                            <button class="btn btn-icon btn-sm btn-outline-secondary edit-domain" data-bs-toggle="modal"
                                ...
                                data-domain-url="{{ route('admin.domains.update', $domain->id) }}"
