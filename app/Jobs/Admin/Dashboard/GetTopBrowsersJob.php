...
class GetTopBrowsersJob implements ShouldQueue
{
    ...
    {
        $key = 'chart_top_browsers_by_date_'.$this->startDate->toDateString().'_'.$this->endDate->toDateString();
        $data = $this->statService->getTopBrowsersByDate($this->startDate, $this->endDate);
