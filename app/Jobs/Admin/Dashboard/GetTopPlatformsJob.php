...
class GetTopPlatformsJob implements ShouldQueue
{
    ...
    {
        $key = 'chart_top_platforms_by_date_'.$this->startDate->toDateString().'_'.$this->endDate->toDateString();
        $data = $this->statService->getTopOSByDate($this->startDate, $this->endDate);
